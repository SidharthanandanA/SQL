...
WITH DeliveryQualitiesCTE AS (
	...
	adq.BuyerSettlementAmount AS 'Claim Amount Recovered (USD)',
 ...
 DeliveryQuantityShortSuppliesCTE AS (
    ...
    END AS 'Claim Status',
	NULL AS 'Claim Amount Raised (USD)',
	adqss.BuyerSettlementAmount AS 'Claim Amount Recovered (USD)',
	NULL AS 'Claim Qty Raised (MT)',
	NULL AS 'Claim Qty Recovered (MT)',
	aid.OperationalNotesClaims AS 'Remarks',
	aup.Name AS 'Trader'
...
DeliveryQuantityDensitiesCTE AS (
	...
	END AS 'Claim Status',
	adqd.ClaimQty *  aisd.BuyPrice AS 'Claim Amount Raised (USD)',
	adqd.BuyerSettlementAmount AS 'Claim Amount Recovered (USD)',
	adqd.ClaimQty AS 'Claim Qty Raised (MT)',
	adqd.ClaimQty AS 'Claim Qty Recovered (MT)',
	aid.OperationalNotesClaims AS 'Remarks',
	aup.Name AS 'Trader'
...
DeliveryQualityWatersCTE AS (
    ...
    END AS 'Claim Status',
	adqw.ClaimQty *  aisd.BuyPrice AS 'Claim Amount Raised (USD)',
	adqw.BuyerSettlementAmount AS 'Claim Amount Recovered (USD)',
	adqw.ClaimQty AS 'Claim Qty Raised (MT)',
	adqw.ClaimQty AS 'Claim Qty Recovered (MT)',
	aid.OperationalNotesClaims AS 'Remarks',
	aup.Name AS 'Trader'
...
DeliveryQualityDelaysCTE AS (
	...
	END AS 'Claim Status',
	NULL AS 'Claim Amount Raised (USD)',
	adqt.BuyerSettlementAmount AS 'Claim Amount Recovered (USD)',
	NULL AS 'Claim Qty Raised (MT)',
	NULL AS 'Claim Qty Recovered (MT)',
	aid.OperationalNotesClaims AS 'Remarks',
	aup.Name AS 'Trader'
