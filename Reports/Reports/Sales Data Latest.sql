...
SELECT
    ...
    [Seller Broker Unit/Lumpsum],
    [Seller Broker Unit],
    [Customer Broker Unit/Lumpsum],
    [Customer Broker Unit],
    [Invoice number],
    [Invoice date],
    [Invoice Type],
    [Job status],
    [Cancellation Status],
    [Inquiry recieved date],
    [Payment due date],
    ...
    [Selling Price(USD)],
    [Buying price],
    [Buying Price Currency type],
    [Buying Price(USD)],
    [CustomerBrokerage],
    [Customer Currency],
    [Customer Brokerage(USD)],
    [SellerBrokerage],
    [Seller Currency],
    [Seller Brokerage(USD)],
    [Margin],
    [MiscCostItemOneName],
    [MiscCostItemOneAmount],
    [MiscCostItemTwoName],
    ...
    [Customer invoice total amount(USD)],
    [Customer invoice sub total],
    [Customer invoice sub total(USD)],
    [Amount received],
    [Amount received(USD)],
    [Customer Grade Misc Cost],
    [CustomerInvAddlCost],
    [Customer Currency Type],
    [Seller invoice total amount],
    [Seller invoice total amount(USD)],
    [Seller invoice sub total],
    [Seller invoice sub total(USD)],
    [Seller Grade Misc Cost],
    [SellerInvAddlCost],
