...
WHERE aid.InquiryStatus IN (650,700,800,900,1000,9000) AND (aic.InvoiceStatus NOT IN (0,10,20) OR ais.InvoiceStatus NOT IN (0,10,20) OR ais.InvoiceType is null) --and aid.Code = 'G2958'
),
CustomerInvoices AS (
    SELECT 
		aid.Code AS 'Job Code',
...
from ExampleCTE --where [Job Code] = 'G2854'