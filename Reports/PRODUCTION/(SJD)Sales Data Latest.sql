...
LEFT JOIN AppInquirySellerDetails aisd ON aisd.InquiryFuelDetailId = aifd.id and aifd.sellerid = aisd.sellerid and aisd.isdeleted = 0
LEFT JOIN AppInquiryNominations ain ON ain.InquirySellerDetailId = aisd.id and ain.InquiryDetailId = aifd.InquiryDetailId and ain.IsDeleted = 0
...
Select 
	* 
from UnionCTE --where [Job Code] IN ('G3127', 'G3115', 'G2854')
ORDER BY 
    CASE 
